...
let API_KEY="9a63d197"
let searchInput=document.getElementById("search-input");
let searchh8tn=document.getElementById("search-btn");
let movieModal=document.getElementById("movie-modal")
let movieContent=document.getElementById("movie-center")

console.log(searchInput)
console.log(searchh8tn)
...
searchh8tn.addEventListener("click",()=>{
    moviesBasedOnSearch()
})
